...
import { CHAPTER_CREATION_FEE, CHAPTER_UNLOCK_FEE, ERROR_MESSAGES, IMAGE_CREATION_FEE, STORY_CREATION_FEE } from 'src/common/constants/app.constant';
...
export class MasterDataService {
    ...
    async getMasterData(userId: string): Promise<any> {
        ...
        const [user, categories, iapProducts] = await Promise.all([
            ...
            this.iapProductService.findAllWithDisplayOrder(),
        ]);
